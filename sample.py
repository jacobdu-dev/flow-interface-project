...
class Sample():
	...
	def get_raw_data(self, x_label= None, y_label = None, row_indicies = None):
		...
		if y_label is None: 
			self.raw_data[:, [int(self.label_indicies[x_label])]].flatten() if row_indicies is None else self.raw_data[[[rows] for rows in row_indicies], [int(self.label_indicies[x_label])]]
	...
	def get_comp_data(self, x_label= None, y_label = None, row_indicies = None):
		...
		if y_label is None: 
			self.comp_data[:, [int(self.label_indicies[x_label])]].flatten() if row_indicies is None else self.comp_data[[[rows] for rows in row_indicies], [int(self.label_indicies[x_label])]]
	...
	def get_xform_data(self, x_label= None, y_label = None, row_indicies = None):
		...
		if y_label is None: 
			self.xform_data[:, [int(self.label_indicies[x_label])]].flatten() if row_indicies is None else self.xform_data[[[rows] for rows in row_indicies], [int(self.label_indicies[x_label])]]
